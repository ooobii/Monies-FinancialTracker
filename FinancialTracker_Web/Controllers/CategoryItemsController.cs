...
namespace FinancialTracker_Web.Controllers
{
    public class CategoryItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ParentCategoryId,Name,Description")] CategoryItem categoryItem)
        {
            ...
            ViewBag.ParentCategoryId = new SelectList(db.Categories, "Id", "Name", categoryItem.ParentCategoryId);
            return View(categoryItem);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ParentCategoryId,Name,Description")] CategoryItem categoryItem)
        {
            if (ModelState.IsValid)
            {
